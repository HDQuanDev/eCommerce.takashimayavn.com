            ...
            <tbody>
                @foreach($categories as $key => $category)
                    <tr>
                        ...
                        <td data-text="{{translate('Parent Category')}}">
                            {{-- <span class="badge badge-inline badge-info">{{ $category->parent->getTranslation('name') }}</span> --}}
                            @php
                        ...
                        <td data-text="{{translate('Order Level')}}">{{ $category->order_level }}</td>
                        <td data-text="{{translate('Level')}}">{{ $category->level }}</td>
                        <td data-text="{{translate('Banner')}}">
                        ...
                        <td data-text="{{translate('Cover Image')}}">
                            {{-- <span class="badge badge-inline badge-info">{{ $category->parent->getTranslation('name') }}</span> --}}
                        ...
                        @if(get_setting('seller_commission_type') == 'category_based')
                            <td data-text="{{translate('Commission')}}">{{ $category->commision_rate }} %</td>
                        @endif
