...
@section('content')
    ...
    <div class="row">
        @foreach ($payment_methods as $payment_method)
            <div class="col-lg-6">
                <div class="card mb-3">
                    <div class="card-header" id="heading-{{ $payment_method->id }}" style="cursor:pointer"
                        data-toggle="collapse" data-target="#collapse-{{ $payment_method->id }}" aria-expanded="false"
                        ...
                        <div class="d-flex justify-content-between w-100">
                            ...
                            <div class="d-flex align-items-center">
                                @if ($payment_method->active == 1)
                                    <span class="badge badge-success badge-inline ml-auto">{{ translate('Active') }}</span>
                                @else
                                    <span class="badge badge-danger badge-inline ml-auto">{{ translate('Inactive') }}</span>
                                @endif
                            </div>
                        </div>
                    </div>
                    <div id="collapse-{{ $payment_method->id }}" class="collapse"
                        aria-labelledby="heading-{{ $payment_method->id }}" data-parent=".row">
                        <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" name="name"
                                            value="{{ $payment_method->name }}" placeholder="{{ translate('Name') }}"
                                            required>
                                    </div>
                                </div>
                                <div class="form-group row">
