    ...
    <div class="aiz-sidebar left c-scrollbar">
        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                <!-- POS manager -->
                @canany(['add_new_product_pos', 'show_all_products_pos'])
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            <div class="aiz-side-nav-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="13.79" height="16"
                        ...
                        <!--Submenu-->
                        <ul class="aiz-side-nav-list level-2">
                            @can('add_new_product_pos')
                                <li class="aiz-side-nav-item">
                                    <a class="aiz-side-nav-link" href="{{ route('products.createPos') }}">
                                        <span class="aiz-side-nav-text">{{ translate('Add New product') }}</span>
                                    </a>
                                </li>
                            @endcan
                            @can('show_all_products_pos')
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('products.allPos') }}" class="aiz-side-nav-link">
                                        <span class="aiz-side-nav-text">{{ translate('All Products') }}</span>
                                    </a>
                                </li>
                            @endcan
                    ...
                    @canany(['view_all_seller', 'seller_payment_history', 'view_seller_payout_requests',
                        ...
                        <li class="aiz-side-nav-item">
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                ...
                                @endcan
                                <!-- Add Seller Packages menu items -->
                                @can('view_seller_packages')
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('seller_packages.index') }}"
                                            class="aiz-side-nav-link {{ areActiveRoutes(['seller_packages.index', 'seller_packages.create', 'seller_packages.edit']) }}">
                                            <span class="aiz-side-nav-text">{{ translate('Seller Packages') }}</span>
                                ...
                                @can('view_seller_package_payments')
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('seller_packages.purchase_history') }}"
                                            class="aiz-side-nav-link {{ areActiveRoutes(['seller_packages.purchase_history']) }}">
                                ...
                                @can('otp_configurations')
                                    <li class="aiz-side-nav-item">
                                        ...
                                        <ul class="aiz-side-nav-list level-2">
                                            @can('otp_configurations')
                                                <li class="aiz-side-nav-item">
                                                    <a href="{{ route('otp.login_configuration') }}"
                                                        class="aiz-side-nav-link">
                                                        <span
