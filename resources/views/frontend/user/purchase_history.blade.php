                ...
                <tbody class="fs-14">
                    @foreach ($orders as $key => $order)
                        @if (count($order->orderDetails) > 0)
                            <tr>
                                <!-- Code -->
                                <td class="pl-0" data-text="{{ translate('Code') }}">
                                    <a href="{{route('purchase_history.details', encrypt($order->id))}}">{{ $order->code }}</a>
                                </td>
                                <!-- Date -->
                                <td class="text-secondary" data-text="{{ translate('Date')}}">{{ date('d-m-Y', $order->date) }}</td>
                                <!-- Amount -->
                                <td class="fw-700" data-text="{{ translate('Amount') }}">
                                    {{ single_price($order->grand_total) }}
                                </td>
                                <!-- Delivery Status -->
                                <td class="fw-700" data-text="{{ translate('Delivery Status') }}">
                                ...
                                <!-- Options -->
                                <td class="text-right pr-0" data-text="{{ translate('Options') }}">
                                    <!-- Re-order -->
                                    <div class="">
