    ...
    <div class="card">
        ...
        <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                <div class="card shadow-none bg-light">
                    <div class="card-header">
                        <h6 class="mb-0">{{ translate('Custom Code') }}</h6>
                    </div>
                    <div class="card-body">
                        <div class="form-group">
                            <label>{{ translate('Custom Code') }}</label>
                            <div class="input-group form-group">
                                <input type="hidden" name="types[]" value="custom_code">
                                <textarea class="form-control" name="custom_code" rows="5">{{ get_setting('custom_code') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
